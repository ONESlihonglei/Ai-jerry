...
if __name__ == '__main__':
    APPId = "512b26ae"
    APISecret = "NjZhZjEwYTdmNjYwYjIxOTZjODNiYWVk"
    APIKey = "5352918b1e1170070e575d6d3f441585"
    file_path = '示例音频/讯飞开放平台 copy 2.mp3'
    # file_path = '示例音频/没问题.mp3'
    # file_path = '示例音频/晚上好.mp3'


    featureId = "002"
    featureInfo="海锋声音"
    groupId="1"
    groupName="jerryGroup"
    groupInfo="jerryGroupGroupInfo"
